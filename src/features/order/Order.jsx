...
export default function Order() {
  ...
  return (
    <div className="px-4 py-6 space-y-8 ">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-6 py-5 bg-slate-300 ">
      ...
      <ul className="border-t border-b border-y divide-slate-400 ">
      ...
      <div className="px-6 py-5 space-y-2 bg-slate-300">
